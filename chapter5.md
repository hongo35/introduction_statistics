...
![alt text](http://chart.apis.google.com/chart?cht=tx&chl={\\displaystyle =1^2 \\times \\frac{1}{20} %2B 2^2 \\times \\frac{1}{10} %2B 3^2 \\times \\frac{1}{4} %2B 4^2 \\times \\frac{3}{10} %2B 5^2 \\times \\frac{1}{4} %2B 6^2 \\times \\frac{1}{20} - \\frac{75}{20} \times \\frac{75}{20} = \\frac{119}{80} ) 
