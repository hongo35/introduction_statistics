...
![alt text](http://chart.apis.google.com/chart?cht=tx&chl=\\mu=1\\times \\frac{1}{20} \\plus 2\\times \\frac{1}{10} + 3\\times \\frac{1}{4} + 4\\times \\frac{3}{10} + 5\\times \\frac{1}{4} + 6\\times \\frac{1}{20}) 
